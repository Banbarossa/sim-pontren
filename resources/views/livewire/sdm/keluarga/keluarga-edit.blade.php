<div>
    ...
    <form action="" method="post" wire:submit.prevent="update">
        ...
        <div class="mb-3">
            ...
            <select class="form-select @error('jenjang_pendidikan') is-invalid @enderror" name="jenjang_pendidikan" id="jenjang_pendidikan" wire:model="jenjang_pendidikan">
        ...
        <div class="mb-3">
            ...
            <select  class="form-select @error('status') is-invalid @enderror" name="status" id="status" wire:model="status">
