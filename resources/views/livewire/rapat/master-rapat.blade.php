    ...
    <div class="row mb-3">
        <x-page-title>
            ...
            <div class="d-flex">
                ...
                @can('admin')
                <a href="{{ route('notulensi.create') }}" class="btn btn-primary px-2 d-inline">Tambah</a>
                @endcan
            </div>
        </x-page-title>
    </div>
            ...
            <div class="col-lg-4 col-md-6 ">
                <div class="card mb-4 shadow rounded">
                    ...
                    <div class="card-body p-3">
                        ...
                        <a href="/notulensi/{{ $item->unik_id }}" class=" d-block btn btn-outline-primary mt-4">Selengkapnya</a>
                    </div>
                </div>
            </div>
        @endforeach
